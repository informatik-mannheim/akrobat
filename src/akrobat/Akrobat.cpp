	...
	scaleFacRot(10)
{
	...
	trajectorySettings[TRIPOD] = TrajectorySettings(40, 60, 15);
	trajectorySettings[WAVE] = TrajectorySettings(40, 60, 15);
	trajectorySettings[RIPPLE] = TrajectorySettings(40, 60, 15);
