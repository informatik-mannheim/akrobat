	...
	scaleFacRot(10)
{
	...
	legSettings[LEFT_FRONT] = LegSetting(	0.0,	180.0,	-51.0,	217.0,	0.0,	-180.0,	10.0,	-90.0,	-37.5,	-99.0,	-135.0,	50.0, 96.0, 135.0);
	...
	legSettings[LEFT_REAR] = LegSetting(	0.0,	180.0,	-51.0,	-217.0,	0.0,	-180.0,	10.0,	-90.0,	-50.0,	-99.0,	-135.0,	50.0, 96.0, 135.0);
...
void Akrobat::shutdownAkrobat(const std_msgs::Bool::ConstPtr& Shutdown)
{
	...
	if(shutdown)
	{
		...
		system("ssh pi@10.42.0.2 'sudo shutdown now'");
